...
export const GALLERY_TEXTURES_VERSIONED = [
    ...
    // Tech stack logos (with painted versions)
    'csslogo',
    'elementorlogo',
    'firebaselogo',
    'htmllogo',
...
// PNG-textured gallery projects (need manual paths since they're .png, not .webp)
export const GALLERY_TEXTURES_PNG = [
    '/textures/gallery/mahaputra.png',
    '/textures/gallery/mahaputra_painted.png',
    '/textures/gallery/managementprint.png',
    '/textures/gallery/managementprint_painted.png',
];

// Tech stack logos without painted versions (loaded as regular only)
export const GALLERY_TEXTURES_SINGLE = [
    '/textures/gallery/golang.webp',
...
export const GALLERY_TEXTURES = [
    ...
    ...GALLERY_TEXTURES_PNG,
    ...GALLERY_TEXTURES_SINGLE,
];
