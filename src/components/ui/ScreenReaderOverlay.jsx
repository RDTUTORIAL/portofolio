    ...
    return (
        <div className="sr-overlay" role="complementary" aria-label="Accessible navigation for 3D portfolio">
            ...
            <nav id="sr-main-nav" className="sr-only" aria-label="Portfolio rooms">
                <h1>Danis — Web Developer Portfolio</h1>
                <h2>Portfolio Navigation</h2>

                {!hasEntered && (
                    <p>Welcome to Danis' interactive 3D portfolio. Click or press Enter on the doors to enter.</p>
                )}
                    ...
                    <>
                        ...
                        {currentRoom === 'contact' && (
                            <div aria-label="Contact room content">
                                <h3>Contact Me</h3>
                                <p>Find my social media links displayed as floating barrels. Click to visit my profiles on Telegram, GitHub, WhatsApp, and Instagram.</p>
                            </div>
                        )}
                        {currentRoom === 'studio' && (
