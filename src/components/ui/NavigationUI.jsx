...
import DraftRoomOverlay from './DraftRoomOverlay';
...
const NavigationUI = () => {
    ...
    const { isBlueprintUnlocked, isBlueprintActive, toggleBlueprintMode, openDraftRoom } = useSecrets();
            ...
            {hasEntered && (
                <>
                    ...
                    {isBlueprintUnlocked && (
                        <>
                            <button
                                className={`nav-btn blueprint-btn ${isBlueprintActive ? 'active' : ''}`}
                                onClick={toggleBlueprintMode}
                                aria-label={isBlueprintActive ? 'Turn off Blueprint Mode' : 'Turn on Blueprint Mode'}
                            >
                                BP
                            </button>
                            <button
                                className="nav-btn draft-room-btn"
                                onClick={openDraftRoom}
                                aria-label="Open The Draft Room"
                            >
                                DR
                            </button>
                        </>
