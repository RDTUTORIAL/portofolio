 ...
 * - DANIS in Rubik Scribble font (splits into letters during scroll)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for DANIS split effect
    const letters = useMemo(() => [
        { char: 'D', baseX: -1.15, splitDir: -1.8, delay: 0 },
        { char: 'A', baseX: -0.55, splitDir: -0.9, delay: 0 },
        { char: 'N', baseX: 0, splitDir: 0, delay: 0 },
        { char: 'I', baseX: 0.52, splitDir: 0.9, delay: 0 },
        { char: 'S', baseX: 1.08, splitDir: 1.8, delay: 0 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of DANIS
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]}>
            {/* DANIS Letters - Rubik Scribble font with fade-in animation */}
