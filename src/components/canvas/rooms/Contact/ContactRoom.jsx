        ...
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                onClick={() => {
                    ...
                    window.open('https://t.me/justinexx666', '_blank');
                }}
            ...
            <SocialBarrel
                ...
                onClick={() => {
                    unlockAchievement('contact_choose');
                    window.open('https://github.com/RDTUTORIAL', '_blank');
                }}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            ...
            <SocialBarrel
                ...
                onClick={() => {
                    unlockAchievement('contact_choose');
                    window.open('https://wa.me/6287856053716', '_blank');
                }}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            ...
            <SocialBarrel
                ...
                onClick={() => {
                    unlockAchievement('contact_choose');
                    window.open('https://www.instagram.com/kd.dnswra/', '_blank');
                }}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
