...
const UNIQUE_PROJECTS = [
    {
        id: 'eastlandbalitour',
        title: 'Eastland Bali Tour',
        front: '/textures/gallery/eastlandbalitour.webp',
        painted: '/textures/gallery/eastlandbalitour_painted.webp',
        url: 'https://eastlandbalitour.com/',
        description: 'A tourism platform for Eastland Bali Tour built with WordPress & Elementor, offering travel packages, destination guides, and seamless booking for exploring Bali.',
        techStack: ['/textures/gallery/wordpresslogo.webp', '/textures/gallery/elementorlogo.webp']
    },
    {
        id: 'intimassurya',
        title: 'Intimas Surya',
        front: '/textures/gallery/intimassurya.webp',
        painted: '/textures/gallery/intimassurya_painted.webp',
        url: 'https://intimassurya.com/',
        description: 'A corporate website for Intimas Surya built with Laravel & PHP, showcasing professional services, company profile, and business solutions.',
        techStack: ['/textures/gallery/laravel.webp', '/textures/gallery/phplogo.webp']
    },
    {
        id: 'iragacoffe',
        title: 'Iraga Coffee',
    ...
    },
    {
        id: 'maguro',
        title: 'Maguro Ubud',
        front: '/textures/gallery/maguro.webp',
        painted: '/textures/gallery/maguro_painted.webp',
        url: 'https://maguroubud.com/',
        description: 'A restaurant and business website for Maguro Ubud built with Laravel, PHP & Tailwind, showcasing their menu, services, and authentic dining experience.',
        techStack: ['/textures/gallery/laravel.webp', '/textures/gallery/phplogo.webp', '/textures/gallery/tailwindlogo.webp']
    },
    {
        id: 'padiconsulting',
        title: 'Padiconsulting',
        front: '/textures/gallery/padiconsulting.webp',
        painted: '/textures/gallery/padiconsulting_painted.webp',
        url: 'https://padiconsulting.id/',
        description: 'A professional consulting firm website built with Laravel & PHP, delivering corporate services, expertise, and client solutions.',
        techStack: ['/textures/gallery/laravel.webp', '/textures/gallery/phplogo.webp']
    },
    {
        id: 'puelldayspa',
        title: 'Puell Day SPA',
        front: '/textures/gallery/puelldayspa.webp',
        painted: '/textures/gallery/puelldayspa_painted.webp',
        url: 'https://puelladayspa.com/',
        description: 'A serene spa and wellness website for Puell Day SPA built with WordPress & Elementor, offering beauty treatments, therapy packages, and relaxation services.',
        techStack: ['/textures/gallery/wordpresslogo.webp', '/textures/gallery/elementorlogo.webp']
    },
    {
        id: 'rajyamuna',
        title: 'RajYamuna School',
        front: '/textures/gallery/rajyamuna.webp',
        painted: '/textures/gallery/rajyamuna_painted.webp',
        url: 'https://www.rajyamuna.sch.id/',
        description: 'An educational institution website for RajYamuna School built with Laravel, PHP & Tailwind, featuring academic programs, student resources, and school information.',
        techStack: ['/textures/gallery/laravel.webp', '/textures/gallery/phplogo.webp', '/textures/gallery/tailwindlogo.webp']
    },
    {
        id: 'samayaspa',
        title: 'Samaya SPA Bali',
        front: '/textures/gallery/samayaspa.webp',
        painted: '/textures/gallery/samayaspa_painted.webp',
        url: 'https://ssamayaspabali.com/',
        description: 'A luxury spa website for Samaya SPA Bali built with WordPress & Elementor, promoting wellness packages, therapeutic treatments, and relaxation experiences.',
        techStack: ['/textures/gallery/wordpresslogo.webp', '/textures/gallery/elementorlogo.webp']
    },
    {
        id: 'blackbaliparedise',
        title: 'Black Bali Paradise',
        front: '/textures/gallery/blackbaliparedise.webp',
        painted: '/textures/gallery/blackbaliparedise_painted.webp',
        url: '#',
        description: 'A resort and villa website for Black Bali Paradise built with WordPress & Elementor, showcasing premium accommodations and authentic Balinese hospitality.',
        techStack: ['/textures/gallery/wordpresslogo.webp', '/textures/gallery/elementorlogo.webp']
    },
    // ---- Client Projects (Private) ----
    {
        id: 'clinico',
        title: 'Clinico',
        front: '/textures/gallery/clinico.webp',
        painted: '/textures/gallery/clinico_painted.webp',
        url: '#',
        description: 'A comprehensive clinic management system built with Go, React, Tailwind & PostgreSQL, handling patient records, appointments, and medical history tracking.',
        techStack: ['/textures/gallery/golang.webp', '/textures/gallery/reactlogo.webp', '/textures/gallery/tailwindlogo.webp', '/textures/gallery/psql.webp']
    },
    {
        id: 'kostmanager',
        title: 'Kost Manager',
        front: '/textures/gallery/kostmanager.webp',
        painted: '/textures/gallery/kostmanager_painted.webp',
        url: '#',
        description: 'A boarding house management system built with Laravel, PHP & Tailwind for landlords to manage tenants, track payments, and handle property operations.',
        techStack: ['/textures/gallery/laravel.webp', '/textures/gallery/phplogo.webp', '/textures/gallery/tailwindlogo.webp']
    },
    {
        id: 'mahaputra',
    ...
    },
    {
        ...
        front: '/textures/gallery/managementprint.png',
        painted: '/textures/gallery/managementprint_painted.png',
        url: '#',
        description: 'A printer fleet management system built with Next.js, React, Tailwind & Firebase for tracking, monitoring, and optimizing printing operations.',
        techStack: ['/textures/gallery/nextjs.webp', '/textures/gallery/reactlogo.webp', '/textures/gallery/tailwindlogo.webp', '/textures/gallery/firebaselogo.webp']
    },
];

const PROJECT_COUNT = 13; // Match the unique projects count
const GAP = 2.5;
...
const GalleryRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const allLogos = useMemo(() => {
        const names = [
            ...
            'tailwindlogo', 'wordpresslogo', 'golang', 'laravel',
            'psql', 'nextjs'
        ];
        const paintedVariants = [
            'elementorlogo', 'firebaselogo', 'htmllogo',
            'jslogo', 'netlifylogo', 'phplogo', 'reactlogo',
        ...
        return names.map(name => {
            ...
            if (paintedVariants.includes(name)) return `/textures/gallery/${name}_painted.webp`;
            return `/textures/gallery/${name}.webp`;
        });
    }, [canHover]);
    ...
    const projects = useMemo(() => {
        return Array.from({ length: PROJECT_COUNT }).map((_, i) => {
            ...
            const techStack = projectData.techStack.map(path => {
                ...
                const ext = path.split('.').pop(); // preserve .webp or .png
                const name = path.split('/').pop().replace(`.${ext}`, '');
                if (name === 'csslogo') return '/textures/gallery/css3logo_painted.webp';
                if (paintedVariants.includes(name)) return `/textures/gallery/${name}_painted.${ext}`;
                return path; // Fallback to regular if no painted variant available
            });
    ...
    useEffect(() => {
        ...
        const scrollObserver = Observer.create({
            ...
            wheelSpeed: -1,
            onWheel: (e) => {
                if (!showRoom || selectedCard !== null || globalIsAnimating || isTransitioning || isDraftRoomBlockingSceneInput()) return;
                const orig = e.event;
                orig.preventDefault();
...
const ProjectCard = memo(forwardRef(({ index, project, clothespinTexture, currentScroll, materials, curve, isSelected, scrollToIndex, onClick, isMobile, isTransitioning, paintProgress, roomOrigin }, ref) => {
    ...
    const textRef = useRef(); // Ref for the title text that sticks to the paper
    const titleGroupRef = useRef(); // Ref for the front caption label
    ...
    useFrame((state) => {
        ...
        // --- Zrównaj pozycję podpisu Z z animacją zaginania i falowania kartki (PRZÓD) ---
        if (titleGroupRef.current && materialRef.current) {
            const y = titleGroupRef.current.position.y;
            ...
            titleGroupRef.current.position.z = bendAmount + flutter + 0.025;
            ...
            titleGroupRef.current.rotation.x = Math.atan(dz_dy);
        }
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {/* Warstwa 2: Napis OPEN PROJECT / PRIVATE (bez eventów) */}
                    <Text
                        ref={openTextRef}
                        position={[0, 0, 0.01]}
                        fontSize={0.11}
                    ...
                    >
                        {project.url && project.url !== '#' ? 'OPEN PROJECT' : 'PRIVATE'}
                    </Text>
                    ...
                    <mesh
                        position={[0, 0, 0.02]}
                        onClick={(e) => {
                            if (isSelected && !isTransitioning && project.url && project.url !== '#') {
                                e.stopPropagation();
                ...
                >
                    ...
                    {/* Kontener na loga - mapowanie do 4 narysowanych kwadratów na teksturze */}
                    <group position={[0, -0.05, 0.01]}>
                        {project.techStack && project.techStack.map((logoPath, idx) => {
                            // Fixed X positions matching the 4 drawn boxes on the tylkartki texture
                            const boxPositions = [-0.45, -0.15, 0.15, 0.45];
                            
                            const total = project.techStack.length;
                            let map = [];
                            
                            if (total === 1) {
                                map = [1]; // Place in the center-left box
                            } else if (total === 2) {
                                map = [1, 2]; // Place in the two middle boxes
                            } else if (total === 3) {
                                map = [0, 1, 2]; // Place in the first 3 boxes
                            } else {
                                map = [0, 1, 2, 3]; // Fill all 4 boxes
                            }
                            
                            // Safe fallback in case there are more than 4 logos
                            const assignedBox = map[idx] !== undefined ? map[idx] : (idx % 4);
                            
                            const xPos = boxPositions[assignedBox];
                            const yPos = 0; // Only one row of boxes exists on the texture

                            return (
                                <TechStackLogo key={idx} path={logoPath} position={[xPos, yPos, 0]} />
                            );
                        })}
                    </group>
                </group>
                ...
                */}
                <group
                    ref={titleGroupRef}
                    position={[0, 0.74, 0]} // Small top label, clear of the screenshot body
                >
                    <Text
                        ref={textRef}
                        position={[0, 0, 0.014]}
