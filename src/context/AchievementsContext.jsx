...
const STORAGE_KEY = 'danis_achievements';
...
export const ACHIEVEMENTS = {
    ...
    secret_hunter: { id: 'secret_hunter', label: 'Find your first secret clue', title: 'Curiosity Spark' },
    blueprint_unlocked: { id: 'blueprint_unlocked', label: 'Find enough clues to unlock Blueprint Mode', title: 'Blueprint Vision' },
    draft_room: { id: 'draft_room', label: 'Open the full hidden archive', title: 'Draft Room Archivist' }
};
