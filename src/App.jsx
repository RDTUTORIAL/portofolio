...
const BlueprintSceneOverlay = ({ active }) => (
  <div className={`blueprint-scene-overlay ${active ? 'active' : ''}`} aria-hidden="true">
    <div className="blueprint-grid-layer" />
    <div className="blueprint-scan-layer" />
  </div>
);
...
function AppContent() {
  ...
  const { isBlueprintActive } = useSecrets();
  ...
  return (
    <AudioProvider>
      <SceneProvider>
        <GlobalAudioEnabler />
        <div className={`app ${isBlueprintActive ? 'blueprint-active' : ''}`}>
          ...
          <div className="canvas-wrapper">
            ...
            >
              <color attach="background" args={[isBlueprintActive ? '#08192a' : '#fafafa']} />
              <fog attach="fog" args={[isBlueprintActive ? '#08192a' : '#fafafa', 15, isBlueprintActive ? 70 : 50]} />
          ...
          <BlueprintSceneOverlay active={isBlueprintActive} />
...
import { SecretsProvider, useSecrets } from './context/SecretsContext';
