...
# rapikan stackn
# lalu isi image di about me, isiin foto juara, isiin foot dokum
# ubah icon di pintu studio
# lalu benerin contct nya 
...
# Portfolio Danis — Master To-Do List
...
- **Pliki:** [SkyChunk.jsx](src/components/canvas/rooms/About/SkyChunk.jsx), [InfiniteSkyManager.jsx](src/components/canvas/rooms/About/InfiniteSkyManager.jsx)
...
- **Pliki:** [StudioRoom.jsx](src/components/canvas/rooms/Studio/StudioRoom.jsx), [GlobalOverlay.jsx](src/components/ui/GlobalOverlay.jsx)
...
- **Pliki:** [InfiniteSkyManager.jsx](src/components/canvas/rooms/About/InfiniteSkyManager.jsx)
...
- **Pliki:** [Corridor.jsx](src/components/canvas/corridor/Corridor.jsx), [Doodles.jsx](src/components/canvas/corridor/Doodles.jsx), [CorridorWalls.jsx](src/components/canvas/corridor/CorridorWalls.jsx)
...
- **Pliki:** [AudioManager.jsx](src/context/AudioManager.jsx), [AudioControls.jsx](src/components/ui/AudioControls.jsx)

### 9. Easter Eggs & detale
- [ ] Konami code? Sekretny pokój?
- [X] Kliknięcie w avatar w About → animacja zmiany wyrazu twarzy
- [X] Kliknięcie wielokrotne w samolot papierowy → looping/spin
- [X] Ukryty element gdzieś w korytarzu (np. pod obrazkiem)
- [ ] Secret mode: Dark mode toggle (cały świat B&W → negatyw)
- [X] Progress bar/counter: "You discovered X/Y secrets"
- [X] Kliknięcie w kawę w korytarzu → animacja pary
- [X] "404" drzwi gdzieś w korytarzu → zabawna animacja
...
- **Pliki:** [contentData.js](src/components/canvas/rooms/Studio/contentData.js)
